...
**Next up:** **T09 (RLS/privilege QA)** → T10 (auth/onboarding, including the account-deletion pseudonymisation decision ADR-0010 leaves open) → T11 (security review).  
